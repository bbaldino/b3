...
use crate::{bit_traits::BitTraits, bit_write::BitWrite};

fn bit_write_exts_helper<T: BitTraits, const N: usize, U: BitWrite + ?Sized>(
    buf: &mut U,
    mut value: T,
) -> std::io::Result<()> {
...
#[cfg(test)]
mod tests {
    use crate::{bit_cursor::BitCursor, bitarray, bitvec};
